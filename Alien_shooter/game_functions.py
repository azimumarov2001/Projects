...
def check_play_button(ai_settings, screen, ship, aliens, bullets, play_button, mouse_x, mouse_y, stats):
...
def check_events(ai_settings, screen, ship, bullets, play_button, aliens, stats):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            sys.exit()
        elif event.type == pygame.MOUSEBUTTONDOWN:
            mouse_x, mouse_y = pygame.mouse.get_pos()
            check_play_button(ai_settings, screen, ship, aliens, bullets, play_button, mouse_x, mouse_y, stats)
...
def check_bullet_alien_collisions(ai_settings, screen, ship, aliens, bullets, stats, sb):
    ...
    if len(aliens) == 0:
        ...
        create_fleet(ai_settings, screen, ship, aliens, rows=2)  # 2 ряда
...
def create_fleet(ai_settings, screen, ship, aliens, rows=1):
...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets, sb):
    ...
    if stats.ships_left > 0:
        ...
        boom_rect.center = ship.rect.center
        screen.blit(boom_image, boom_rect)
        pygame.display.flip()
        sleep(0.3)
